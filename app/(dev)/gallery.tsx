...
const SCREENS: ScreenCard[] = [
  ...
  { name: 'Provider Dashboard (demo)', nameHe: 'לוח בעל מקצוע — דמו', route: '/(dev)/dashboard-demo', icon: 'analytics-outline', group: 'בעל מקצוע' },
  { name: 'Provider Dashboard (live)', nameHe: 'לוח בעל מקצוע — חי', route: '/(tabs)/dashboard', icon: 'briefcase-outline', group: 'בעל מקצוע' },
