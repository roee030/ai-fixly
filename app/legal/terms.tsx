    ...
    <ScreenContainer maxWidth={720}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          &quot;ai-fixly&quot; (להלן: &quot;האפליקציה&quot; או &quot;השירות&quot;) היא פלטפורמה המחברת בין לקוחות הזקוקים לשירותי בית לבין בעלי מקצוע באזורם. השירות מופעל על ידי ai-fixly.
        </Text>

        <Text style={styles.sectionTitle}>2. תיאור השירות</Text>
        <Text style={styles.paragraph}>
          האפליקציה מאפשרת למשתמשים לצלם תמונה או סרטון של בעיה ביתית, לקבל ניתוח אוטומטי באמצעות בינה מלאכותית, ולקבל הצעות מחיר מבעלי מקצוע מקומיים. ai-fixly משמשת כמתווכת בלבד ואינה מספקת בעצמה שירותי תיקון או תחזוקה.
        </Text>

        <Text style={styles.sectionTitle}>3. אחריות</Text>
        <Text style={styles.paragraph}>
          ai-fixly אינה אחראית לאיכות העבודה של בעלי המקצוע, למחירים שנקבעים, או לכל נזק שנגרם כתוצאה משימוש בשירות. האחריות על בחירת בעל מקצוע ועל ההתקשרות עימו היא של המשתמש בלבד.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ai-fixly שומרת לעצמה את הזכות לעדכן תנאים אלה בכל עת. המשך השימוש בשירות לאחר עדכון התנאים מהווה הסכמה לתנאים המעודכנים.
        </Text>
